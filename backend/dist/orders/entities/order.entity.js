...
const orderdetail_entity_1 = require("../../orderdetails/entities/orderdetail.entity");
...
__decorate([
    typeorm_1.Column({ default: 'processing' }),
...
__decorate([
    typeorm_1.OneToMany(() => orderdetail_entity_1.Orderdetail, (orderdetail) => orderdetail.orderId),
